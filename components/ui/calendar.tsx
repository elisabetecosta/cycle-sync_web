    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 rounded-full opacity-50 hover:opacity-100"
        ),
        ...
        day_selected:
          "bg-transparent text-primary hover:bg-accent/90 focus:bg-accent/90 rounded-full",
        day_today: "bg-accent text-accent-foreground rounded-full",
        day_outside:
          "day-outside text-muted-foreground aria-selected:bg-accent/50 aria-selected:text-muted-foreground rounded-full rounded-full",
